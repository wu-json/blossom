...
import sharpNodePath from "../../node_modules/@img/sharp-linux-arm64/lib/sharp-linux-arm64.node" with { type: "file" };
// @ts-ignore - Bun-specific import with type: "file"
import libvipsPath from "../../node_modules/@img/sharp-libvips-linux-arm64/lib/libvips-cpp.so.8.17.3" with { type: "file" };

export const PLATFORM = "linux-arm64";
export const SHARP_NODE_EMBEDDED = sharpNodePath;
export const LIBVIPS_EMBEDDED = libvipsPath;
export const LIBVIPS_FILENAME = "libvips-cpp.so.8.17.3";
